...
label_options = [{'label': 'All Sites', 'value': 'ALL'}]
for i in labels:
    label_options.append({'label': i, 'value': i})
#print(label_options)
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.Dropdown(id='site-dropdown', options=label_options,
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        #filtered_df.columns=['class','value']
        filtered_df['label']=filtered_df.index
        #print(filtered_df)
